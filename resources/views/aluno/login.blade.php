...
<div style="min-height:calc(100vh - 60px); display:flex; align-items:center; justify-content:center; padding:1.5rem;">
    <div style="width:100%; max-width:420px;">
        ...
        <div style="margin-bottom:2.5rem; text-align:center;">
            <p style="font-family:'Space Grotesk',monospace; font-size:0.75rem; font-weight:700; letter-spacing:0.2em; text-transform:uppercase; color:#999; margin-bottom:0.75rem;">Portal do Aluno</p>
        ...
        <div class="glass" style="border-radius:4px; padding:2.5rem;">
            ...
            <form method="POST" action="{{ route('login.aluno') }}" style="display:flex; flex-direction:column; gap:1rem;">
                @csrf
                ...
                <div>
                    <label style="display:block; font-family:'Space Grotesk',monospace; font-size:0.75rem; font-weight:700; letter-spacing:0.2em; text-transform:uppercase; color:#999; margin-bottom:0.5rem;">Matrícula / RA / CPF / E-Mail</label>
                ...
                <div>
                    ...
                    <div style="position:relative;">
                        <input type="password" name="password" id="pal-password" required
                            ...
                            onfocus="this.style.borderColor='rgba(255,255,255,0.35)'"
                            onblur="this.style.borderColor='rgba(255,255,255,0.1)'">
                        <button type="button" onclick="var i=document.getElementById('pal-password');i.type=i.type==='password'?'text':'password';"
